        ...
        "))
          ...
          conditionalPanel(
              ...
              absolutePanel(
                  ...
                  tags$h4(icon("cogs"), "SCAN Explorer"),
          ...
          tabItems(
                      ...
                      fluidRow(
                          ...
                          column(width = 4,
                             box(width = NULL, title = "1. Calculate Index", status = "warning", solidHeader = TRUE,
                                 ...
                                 actionButton("calculate_Cs", "Apply Cs Index", 
                                                 class = "btn-warning align-btn", width = "100%", icon = icon("play")),
                                 
                                 tags$hr(),
                                 numericInput("filter_Cs", "Minimum Cs value:", value = 0.1, step = 0.05),
                             ...
                             # Upload Cs !!!
                             box(width = NULL, title = "2. Upload Index", status = "warning", solidHeader = TRUE,
                                 tags$strong("Upload a previously calculated Cs table?"),
                          ...
                          # Data Management Box
                          column(width = 4,
                             box(width = NULL, title = "4. Data Management", status = "warning", solidHeader = TRUE,
                          ...
                          # check Cs network
                          column( 4, 
                              box(width = NULL, title = "5. Graph Check", status = "warning", solidHeader = TRUE,
                          ...
                          fluidRow(
                              column(width = 6,
                                     ...
                                     box(width = NULL, title = "2. Results & Downloads", status = "danger",
                                         ...
                                         box(
                                             tags$h4("3. Preview Data:"),
                                             tableOutput("scan_chorotypes_summary"),
                                         ),
                                     ),    
                              ),
                              column(6,
                                     ...
                                     # Chorotypes
                                     box(width = NULL, title = "4. Species & Chorotypes", status = "danger",
              ...
              # 6. MAP VIEWWER 1: TELA CHEIA (LEAFLET) ----
              tabItem("map_view",
