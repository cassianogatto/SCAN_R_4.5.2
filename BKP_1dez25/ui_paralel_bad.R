...
pacman::p_load(shiny, dplyr, sf, igraph, tidygraph, DT,
               leaflet, ggplot2, ggraph, tidyr, lwgeom, 
               shinydashboard, future, future.apply)
                ...
                dashboardBody(
                  ...
                  conditionalPanel(
                    ...
                    absolutePanel(
                      ...
                      tags$h3(icon("cogs"), "SCAN Explorer"),
                      ...
                      selectInput("layout_graph", "Graph Layout:", choices = c("fr", "nicely", "kk", "circle"))
                    )
                  ),
                  ...
                  tabItems(
                    ...
                    tabItem("about_SCAN",
                            fluidPage(
                              ...
                              tags$br()
                              # Removed commented out fluidRow to avoid trailing comma error
                            )
                    ),
                    ...
                    # 4. SPATIAL CONGRUENCE TAB (CORRIGIDA) ----
                    tabItem("Cs_tab",
                            fluidPage(
                              ...
                              fluidRow(
                                column(width = 6,
                                       box(width = NULL, title = "1. Calculate Index", status = "warning", solidHeader = TRUE,
                                           ...
                                           tags$hr(),
                                           tags$strong("Processing Mode:"),
                                           radioButtons("calc_method", NULL,
                                                        choices = c("Standard (Single Core)" = "standard",
                                                                    "Parallel (Multi Core - Faster for large data)" = "parallel"),
                                                        selected = "standard"),
                            ...
                            div(class = "full-screen-map",
                                ...
                                conditionalPanel(
                                  ...
                                  absolutePanel(
                                    ...
                                    draggable = TRUE,
                                    tags$h3(icon("heart"), "Network Topology", style = "margin: 0px 0px 5px 5px; font-weight: bold; opacity: 0.7;"),
                    ...
                    tabItem("static_view",
                            fluidPage(
                              fluidRow(
                                ...
                                # Removi a coluna(1,) vazia e problemática
                                column(2) # Espaçamento limpo
                              ),
                              fluidRow(
                                column(12,
